    ...
    public void onTick(TickEvent ticks) {
        ...
        if(mc.thePlayer.isSprinting()) {
            ...
            if(sprintingLevelExp >= 1) {
                ...
                msgLevelUp("Sprinting skill level up! Current level: " + ConfigStats.sprintLevel);
            }
        }
    }
    ...
    public void onRenderOverlay(RenderGameOverlayEvent.Post event) {
        if(event.type == RenderGameOverlayEvent.ElementType.ALL) {
            ...
            if(mc.thePlayer.isSprinting()) {
                ...
                Gui.drawModalRectWithCustomSizedTexture(27, 5, 0, 0, 24, 16, 8, 8);
                new TextUtils(mc, EnumChatFormatting.BOLD + (EnumChatFormatting.GREEN + " " + EnumChatFormatting.GREEN + EnumChatFormatting.BOLD + "Sprinting " + format.format(sprintingLevelExp)), 65, 5, 1, false);
            }
        }
    }
}
