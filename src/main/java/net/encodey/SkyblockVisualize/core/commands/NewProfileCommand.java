...
import net.encodey.SkyblockVisualize.core.BooleanCooldownText;
...
public class NewProfileCommand extends CommandManager {
    ...
    public void processCommand() {
        if(createdProfile) {
            ...
            new SoundEvent(buf);
            BooleanCooldownText.getCooldown().set_newProfileCommandUsed(true);
            return;
        }
        ...
        BooleanCooldownText.getCooldown().set_newProfileCommandUsed(false);
