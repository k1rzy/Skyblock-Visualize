...
public class NewMainGui extends GuiScreen implements GuiVisualize {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new CraftingTableButton(0, width / 2 - 100, height / 4 + 160,56, 56, ""));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        new TextUtils(mc, EnumChatFormatting.RED + "Current defense - "
                + EnumChatFormatting.GREEN
                + PLAYER_DEFENSE()
                , Positions.TOP_LEFT_XW, Positions.TOP_LEFT_YH + 100, 1, true);

        new TextUtils(mc, EnumChatFormatting.RED + "Food - "
                + EnumChatFormatting.GREEN
                + decimalFormat.format(PLAYER_FOOD())
                + "/"
                + decimalFormat.format(PLAYER_MAX_FOOD()), Positions.TOP_LEFT_XW, Positions.TOP_LEFT_YH - 25, 1, true);

        new TextUtils(mc, EnumChatFormatting.RED + "Selected item - "
                + EnumChatFormatting.GREEN
                + SELECTED_ITEM(), Positions.BOTTOM_CENTERED_XW + 50, Positions.BOTTOM_CENTERED_YH - 101, 1, false);
        ...
        new ConstructFontTexturedUtil(mc, EnumChatFormatting.AQUA + "Platina - "
                ...
                , Positions.TOP_LEFT_YH + 40
                , 1
                , new ResourceLocation("svtextures", "textures/stat_textures/platina.png"), 16, 16
                , Positions.TOP_LEFT_XW + 54
                , Positions.TOP_LEFT_YH + 45
                , true);
